...
/***/ function(module, exports, __webpack_require__) {
	...
	var twoColListItems = [{ title: 'One' }, { title: 'Two' }, { title: 'Three' }, { title: 'Four' }];

	/* harmony default export */ exports["default"] = function () {
	  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
	    'article',
	    { className: 'home' },
	    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_components_Header__["a" /* default */], { title: 'Home', className: 'header-dark' }),
	    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_components_List_List__["a" /* default */], { columns: 2, items: twoColListItems })
	  );
	};
